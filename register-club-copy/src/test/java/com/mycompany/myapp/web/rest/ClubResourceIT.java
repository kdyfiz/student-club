...
import static com.mycompany.myapp.domain.ClubAsserts.*;
...
class ClubResourceIT {
    ...
    public static Club createEntity() {
        return new Club().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
    }
    ...
    public static Club createUpdatedEntity() {
        return new Club().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    }
    ...
    void putExistingClub() throws Exception {
        ...
        updatedClub.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateClubWithPatch() throws Exception {
        ...
        partialUpdatedClub.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
