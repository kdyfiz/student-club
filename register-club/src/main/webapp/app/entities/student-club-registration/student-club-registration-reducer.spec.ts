...
import reducer, {
  ...
  reset,
  updateEntity,
} from './student-club-registration.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTCLUBREGISTRATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTCLUBREGISTRATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDENTCLUBREGISTRATION actions', async () => {
      const arg = { id: 29977 };
    ...
    it('dispatches UPDATE_STUDENTCLUBREGISTRATION actions', async () => {
      const arg = { id: 29977 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTCLUBREGISTRATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDENTCLUBREGISTRATION actions', async () => {
      const arg = 42666;
