...
import { EntityArrayResponseType, RegistrationService } from '../service/registration.service';
...
export class RegistrationComponent implements OnInit {
  ...
  trackId = (item: IRegistration): number => this.registrationService.getRegistrationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.registrations.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IRegistration[] | null): IRegistration[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.registrationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
