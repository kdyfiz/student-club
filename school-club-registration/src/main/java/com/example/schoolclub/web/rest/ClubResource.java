...
import com.example.schoolclub.service.ClubService;
...
/**
 * REST controller for managing {@link com.example.schoolclub.domain.Club}.
 */
@RestController
...
public class ClubResource {
    ...
    public ResponseEntity<Club> createClub(@Valid @RequestBody Club club) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/clubs/" + club.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, club.getId().toString()))
            .body(club);
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Club>> getAllClubs(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
