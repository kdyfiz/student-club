...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '42a7805a-32ba-4ea4-b977-c83915ef80c5' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('5d7f1009-5f01-4183-a67a-2dcce600dfa5');
      cy.get(`[data-cy="name"]`).should('have.value', '5d7f1009-5f01-4183-a67a-2dcce600dfa5');
